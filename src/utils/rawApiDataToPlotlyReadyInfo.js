const rawApiDataToPlotlyReadyInfo = (view, office, data) => {
  ...
  if (view !== 'citizenship') {
    //!the importance of this distinction is that the citizenship view uses a different endpoint, so all of this function enclosed is not necessary for that path
